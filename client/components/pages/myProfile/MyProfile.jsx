...
import DesktopModalComponent from '../../DesktopModalComponent/DesktopModalComponent';
...
const MyProfile = () => {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      ...
      const currentUser = await data.find((el) => el.email === userEmail);
    ...
    <>
      <div className="profile_page">
              ...
              <div className="row align-items-center g-5">
                ...
                <div className="col-lg-3">
                  ...
                  <div className="profile_contact">
                    <div className="edit">
                      <Link to='/profile/edit'>Redaktə et</Link>
                    </div>
        ...
        <div className="profil_page_card">
          <div className="container ">
            <div className="long_underline">
              <svg xmlns="http://www.w3.org/2000/svg" width="1206" height="6" viewBox="0 0 1206 6" fill="none">
                <path d="M1203 3H2.99995" stroke="url(#paint0_linear_371_6174)" strokeWidth="5" strokeLinecap="round" />
                <defs>
                  <linearGradient id="paint0_linear_371_6174" x1="26.6136" y1="3.51573" x2="1192.08" y2="3.50631" gradientUnits="userSpaceOnUse">
                    <stop offset="0.282333" />
                    <stop offset="0.371409" stop-color="#C5221F" />
                    <stop offset="0.599908" stop-color="#C5221F" />
                    <stop offset="0.656065" />
                    <stop offset="1" />
                  </linearGradient>
                </defs>
              </svg>
            ...
            <div className="row">
              <div className="profile_card_filters">
                <div className="filter_option" onClick={() => setFilter('posts')}
                  style={{ border: filter === 'posts' ? '2px solid #000' : '' }}
                >
                  <img src="/assets/profile_filter1.png" alt="" />
                  <span>Şəkillər</span>
                </div>
                <div className="filter_option" onClick={() => setFilter('saved')}
                  style={{ border: filter === 'saved' ? '2px solid #000' : '' }}
                >
                  <img src="/assets/profile_saved.png" alt="" />
                  <span>Saved</span>
                </div>
                <div className="filter_option" onClick={() => setFilter('mentioned')}
                  style={{ border: filter === 'mentioned' ? '2px solid #000' : '' }}
                >
                  <img src="/assets/profile_mentioned.png" alt="" />
                  <span>Mentioned</span>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              {
                ...
                user?.[filter]?.map((el, idx) => (
                  <div key={idx} className="col-lg-4 col-md-6 second" onClick={() => setOpenModal(true)}>
                    <div className="img1"
      ...
      {/* {
        user?.posts?.map((post, index) => (
          filter === 'posts' &&
          index === modalIndex &&
          (<DesktopModalComponent post={post} key={index} />)
        ))
      }
      {
        user?.saved?.map((post, index) => (
          filter === 'saved' &&
          index === modalIndex &&
          (openModal && <DesktopModalComponent post={post} key={index} />)
        ))
      }

      {
        user?.mentioned?.map((post, index) => (
          filter === 'mentioned' &&
          index === modalIndex &&
          (openModal && <DesktopModalComponent post={post} />)
        ))
      } */}
...

      {
        isMobile &&
        openModal && (
          <ModalcardComponent content={modalContent} />
        )
      }
      ...
      {/* {
        user?.posts?.map((post, index) => (
          ...
          (<div className={openModal ? 'mobile_modal  open_mobile_modal' : 'mobile_modal'}>
            <ModalcardComponent content={post} />
          </div>)
        ))
      }
      {
