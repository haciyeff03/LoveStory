                ...
                <div className="card_top">
                    <div className="card_author">
                        <div className="author_photo">
                            <img src="https://s3-alpha-sig.figma.com/img/9e72/9cfc/2fb3451f2790627112ebba6732cb7a49?Expires=1691366400&Signature=goUJn6isUQytwYdS0J5XhsErx8t2jtHYo1O713HjFmB5j3-Us6Twlf82gQqHhVUp2FyrNNCBP2UpgZ~6jBL-LCnaKRCDVTY3iL5qzJGmEmsXtjoETvB0~p7Jh-aFtq3hJV~Zw05qerK-uIOfPLi3~uKyPePMUhk7e4TlU1ZuqT~P76~y6alD3O2FCa0KH8~PRK7hWY~PrhtyRabW~x1ruDHtYbCOXY0W2HJXrquzdeB~OyCIsd~LH5MKqSdjM4qeTABMQUrfSG0Z-Rqwrf4WsbgfQEFMPppasCOe4QTvagxL0KJxcpdewnJtXPEt7SkyWEDjAtdL64iWsBAkWrmblg__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="profile" />
                        </div>
                ...
                <div className="card_image">
                    {
                        content?.images.length > 1 && (
                            <div className="slide_fraction">
                                {`${activeIndex}/${content?.images.length}`}
                            </div>
                        )
                    }

                    {
                        content?.images.length > 1 ? (
                            <Swiper
                                ...
                                slidesPerView={1}
                                onSlideChange={(el) => setActiveIndex(el.activeIndex + 1)}
                            >
